  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        setIsExclusive(data.exclusive || false);
              ...
              <div className="formDiv flex">
                ...
                <form className="form grid" onSubmit={submitHandler}>
                  ...
                  <div className="inputDiv">
                    ...
                    <div className="input flex">
                      <input type="checkbox" id="isAdmitted" checked={isAdmitted} onChange={(e) => setIsAdmitted(e.target.checked)} />
                    </div>
                  </div>
                  <div className="inputDiv">
                  ...
                  <div className="inputDiv">
                    ...
                    <div className="input flex">
                      <select id="daysFrequency" value={daysFrequency} onChange={(e) => setDaysFrequency(e.target.value)}>
                  ...
                  <div className="inputDiv">
                    ...
                    <div className="input flex">
                      <input type="number" id="minOrders" value={minOrders} min={1} onChange={(e) => setMinOrders(e.target.value)} />
                    </div>
                  </div>
